...
def get_predicted_answer(prediction: dict[str, Any]) -> str:
    """
    Tahmin edilen cevabı olası alanlardan çıkarır.
    """
...
def extract_answer_texts(value: Any) -> list[str]:
    """
    Farklı reference answer yapılarını recursive açar.
    """
...
def get_gold_answers(prediction: dict[str, Any]) -> list[str]:
    """
    Gold cevapları farklı olası alanlardan çıkarır.
    """
...
def normalize_answer(text: str) -> str:
    """
    SQuAD tarzı answer normalization uygular.
    """
...
def parse_boolean(value: Any, default: bool = True) -> bool:
    """
    Farklı boolean formatlarını güvenli biçimde okur.
    """
...
def calculate_exact_match(predicted_answer: str, gold_answer: str) -> float:
    """
    Normalize edilmiş Exact Match hesaplar.
    """
...
def calculate_token_f1(predicted_answer: str, gold_answer: str) -> float:
    """
    Prediction ile gold answer arasında token F1 hesaplar.
    """
...
def calculate_answer_metrics(prediction: dict[str, Any]) -> dict[str, Any]:
    """
    Prediction için EM, F1 ve relaxed correctness hesaplar.
    """
    ...
    # Yüksek token örtüşmesine sahip span farklarını
    # gerçek QA hatasından ayırıyoruz.
...
def classify_evidence_case(relaxed_correct: bool, evidence_support: str) -> str:
    """
    QA correctness ile verifier etiketini birleştirir.
    """
...
def build_analysis_case(prediction: dict[str, Any], index: int) -> dict[str, Any]:
    """
    Tek prediction için analiz kaydı oluşturur.
    """
...
def print_case(case: dict[str, Any]) -> None:
    """
    Analiz vakasını terminale yazdırır.
    """
...
def analyze_evidence_errors(
    ...
    """
    Evidence verifier hata analizi gerçekleştirir.
    """
